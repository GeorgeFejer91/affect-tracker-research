...
export function validateResearchRunManifestV3(value) {
  ...
  const output = {
    ...
    playbackMode: enumeration(value.playbackMode, "ResearchRunManifestV3.playbackMode", ["unqualifiedWebview", "unqualifiedWebview", "browserMediaAdapters"]),
  ...
  const validPlayback = output.build.platform === "tauri-windows"
    ? ["unqualifiedWebview:qualifiedNative", "unqualifiedWebview:unqualified"].includes(playbackPair)
