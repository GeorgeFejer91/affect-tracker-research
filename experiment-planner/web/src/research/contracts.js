...
export function validateResearchRunManifestV2(value) {
  ...
  const output = {
    ...
    playbackMode: enumeration(value.playbackMode, "ResearchRunManifestV2.playbackMode", ["unqualifiedWebview", "browserMediaAdapters"]),
    playbackQualification: enumeration(value.playbackQualification, "ResearchRunManifestV2.playbackQualification", ["unqualified", "browser"]),
