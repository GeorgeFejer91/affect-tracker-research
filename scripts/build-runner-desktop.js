// Builds the independent executable with its own embedded frontend resources.
// --run is an explicit developer launch; a build alone never opens UI.
...
const env = { ...process.env, TAURI_CONFIG: readFileSync(resolve(root, "native/tauri.runner.conf.json"), "utf8") };
