...
const expectedKinds = ["index.html", "runner.js", "runner.css", "runner-symbol.svg", "app-symbol.svg", "professor-qr.svg", "controller-qr.svg"];
...
const actualKinds = files.map(file => file === "index.html" ? file : file.replace(/^assets\/(professor-qr|controller-qr|runner-symbol|app-symbol|flubber-input-dark|flubber-input-light|runner)-[\w-]+\.(js|css|svg)$/u, "$1.$2"));
