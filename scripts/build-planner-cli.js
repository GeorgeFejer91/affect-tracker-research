...
run(process.execPath, [resolve(root, "node_modules/vite/bin/vite.js"), "build", "--config", "experiment-planner/desktop/vite.config.js"]);
...
run(cargo, ["build", "--manifest-path", "native/Cargo.toml", "--locked", "--bin", "affect-planner-cli",
