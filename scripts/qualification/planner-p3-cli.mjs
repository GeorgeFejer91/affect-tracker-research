...
// node scripts/qualification/planner-p3-cli.mjs <browser.exe> <new-output-dir> [width] [populated|actions|invalid]
...
try {
  const profile = await mkdtemp(join(output, "isolated-profile-")), screenshot = join(output, "p3.png");
