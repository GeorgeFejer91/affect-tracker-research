...
import { initializeResearchUi } from './experiment-planner/web/src/research/app.js';
import { renderResearchUiMarkup } from './experiment-planner/web/src/research/ui-view.js';
import { SETUP_SECTIONS, MAPPING_FIELDS } from './experiment-planner/web/src/research/ui-contracts.js';
import { SETUP_CONFIRMATION_SEGMENTS } from './experiment-planner/web/src/research/setup-confirmation-flow.js';
import { canonicalJson } from './experiment-planner/web/src/research/canonical.js';
import { createExperimentPackageV1, serializeExperimentPackageV1 } from './experiment-planner/web/src/research/experiment-package.js';
...
const bundle = await build({ write: false, bundle: true, format: "iife", stdin: { contents: source, resolveDir: process.cwd() },
  define: { "import.meta.url": JSON.stringify(pathToFileURL(resolve("experiment-planner/web/src/research/ui-view.js")).href) }, logLevel: "silent" });
