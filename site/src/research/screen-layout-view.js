...
export function screenLayoutDraftMarkup() {
  return `<div id="screen-layout-editor" class="screen-layout-draft" data-screen-layout-draft>
    ...
    <p class="layout-legend">Border: viewport · dashed frame: reference · filled rectangle: video · dotted frame: maximum animation · circle: nominal Flubber · crosses: centres</p>
