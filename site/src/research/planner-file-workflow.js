  ...
  return Object.freeze({
    ...
    async save() {
      ...
      if (!copy) {
        ...
        capture = captureGuiInput(registry, { ...getRecipeOptions(), isCurrent: current });
      }
      ...
      return exporter.save({ isCurrent: valid,
        async compile() {
          ...
          return compileGuiDocument(capture.input);
        },
