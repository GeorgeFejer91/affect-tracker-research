...
import { parsePlannerRecipeFile, parseSupportedPlannerRecipe } from "../../experiment-planner/web/src/research/planner-recipe.js";
import { readPlannerRecipeJsonBytes, PLANNER_RECIPE_SCHEMA } from "../../experiment-planner/web/src/research/planner-recipe-wire.js";
...
export function runnerMasterFeedbackState(feedback, x = 0, y = 0) {
  ...
  return {
    x, y, gridVisible: feedback.visual.gridEnabled, flubberVisible: feedback.visual.flubberEnabled, hideFeedback: feedback.visual.hideFeedback,
