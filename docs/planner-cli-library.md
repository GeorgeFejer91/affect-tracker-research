...
This allocation extends [the Planner CLI reference](../docs/planner-cli.md) and the active
[Runner requirements](../for-ai/65-RUNNER-SEGMENTS.md). It adds documentation,
...
| [Public About reference](../experiment-planner/web/index.html) | User-facing CLI library and examples; allocated to Online Version, awaiting integration |
...
in [65-RUNNER-SEGMENTS.md](../for-ai/65-RUNNER-SEGMENTS.md). This establishes a seven-owner native
...
- [ ] Update this entry point if ownership, document locations or workflow change.
  ...
  their command metadata and documentation.
