> Historical snapshot before the correspondence audit. This preserves prior guidance and receipts; use the current for-ai entrypoints for instructions.
...
continue through the information stream. See [SurveyJS contracts](../surveyjs-questionnaires.md)
...
questionnaires/answers and every identified video/ISI transition. See [69](../../for-ai/69-CLI-RUNNER-END-TO-END-GOAL.md).
...
Runner actions. See [69](../../for-ai/69-CLI-RUNNER-END-TO-END-GOAL.md) for allocation,
...
completion. [16](../../for-ai/16-COMPANION-APP-BOUNDARY.md) defines the two-program boundary.
...
see [the exact contract](../runner-version-preselection.md). This is not a
