...
[16-COMPANION-APP-BOUNDARY.md](../../for-ai/16-COMPANION-APP-BOUNDARY.md) supersedes earlier
single-executable wording and blanket Runner deferral in this historical text.
Runner allocations use [65-RUNNER-SEGMENTS.md](../../for-ai/65-RUNNER-SEGMENTS.md); shared
producer/consumer coverage uses [66-PLANNER-RUNNER-COMPATIBILITY.md](../../for-ai/66-PLANNER-RUNNER-COMPATIBILITY.md).
...
- [`15-RESEARCH-V1-CHARTER.md`](../../for-ai/15-RESEARCH-V1-CHARTER.md) is the sole active
...
- [`05-PROJECT-METADATA.md`](../../for-ai/05-PROJECT-METADATA.md) records repository,
  checkpoint, product, and source identity.
- [`10-PRODUCT-REQUIREMENTS.md`](../../for-ai/10-PRODUCT-REQUIREMENTS.md) restates the
  user-visible contract.
- [`20-ARCHITECTURE.md`](../../for-ai/20-ARCHITECTURE.md) assigns native, browser, media,
  timing, data, and presentation authority.
- [`30-TESTING-AND-RELEASE.md`](../../for-ai/30-TESTING-AND-RELEASE.md) defines acceptance
  and qualification evidence.
- [`40-ROADMAP.md`](../../for-ai/40-ROADMAP.md) retains implementation and qualification
  receipts; `60-SEGMENT-CATALOGUE.md` owns the current capability checklist.
- [`45-FUTURE-AGENT-CHECKLIST.md`](../../for-ai/45-FUTURE-AGENT-CHECKLIST.md) tracks
  historical deferred issues, mapped to central catalogue IDs for current work.
- [`50-AGENT-WORKFLOW.md`](../../for-ai/50-AGENT-WORKFLOW.md) defines the pass-intent
  check, three-stage development and verification workflow, change discipline,
  and skill routing.
- [`55-AGENT-MESSAGE-BOARD.md`](../../for-ai/55-AGENT-MESSAGE-BOARD.md) coordinates
...
- [`60-SEGMENT-CATALOGUE.md`](../../for-ai/60-SEGMENT-CATALOGUE.md) is the central final-state
...
- [`61-IMPLEMENTATION-AUDIT.md`](../../for-ai/61-IMPLEMENTATION-AUDIT.md) preserves the dated
...
- [`62-PLANNER-CLOSURE-PLAN.md`](../../for-ai/62-PLANNER-CLOSURE-PLAN.md) prioritizes incomplete
...
- [`70-RESEARCH-PROVENANCE.md`](../../for-ai/70-RESEARCH-PROVENANCE.md) and
  [`references.bib`](../../for-ai/references.bib) record active source decisions.
