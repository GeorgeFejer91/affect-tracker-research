...
impl ResearchRuntime {
    ...
    /// once a separately approved native renderer boundary exists.
...
fn manifest_playback_mode(mode: PlaybackMode) -> ResearchResult<RunPlaybackModeV1> {
    match mode {
        PlaybackMode::LegacyNativePlayer => Err(CommandError::invalid_contract(
...
mod tests {
    ...
    fn finalization_rejects_playback_or_terminal_provenance_changes() {
        ...
        changed_playback.playback_mode = PlaybackMode::LegacyNativePlayer;
    ...
    fn journal_append_cannot_change_frozen_playback_provenance() {
        ...
        fixture.files.journal.playback_mode = PlaybackMode::LegacyNativePlayer;
    ...
    fn native_run_writes_parity_tables_manifest_and_no_names() {
        ...
        let qualified = runtime.start_run(StartRunRequest {
            ...
            playback_mode: PlaybackMode::LegacyNativePlayer,
        });
